  ...
  return <>
      ...
      <main id="top" className="relative overflow-hidden">
          ...
          <div className="relative rounded-2xl border border-border/40 bg-background/80 backdrop-blur-sm py-14 md:py-20 px-6 md:px-12 overflow-hidden">
            ...
            <section className="grid md:grid-cols-2 gap-10 items-center relative">
              <article className="text-center md:text-left">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">Sarthak Jaiswal — Business Analyst</h1>
              ...
              <aside className="order-first md:order-none">
                <div className="relative mx-auto w-52 h-52 md:w-64 md:h-64 rounded-full border border-border/60 shadow-glow overflow-hidden">
                  <img src="/lovable-uploads/c06f2537-2c26-46b4-9074-c0d92a2d3a29.png" alt="Professional headshot of a business analyst" loading="lazy" className="w-full h-full object-cover" />
                </div>
              </aside>
            </section>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <aside className="rounded-xl border border-border/40 p-6 bg-card">
              ...
              <ul className="text-sm text-muted-foreground grid grid-cols-2 gap-2">
                <li className="group relative rounded-md px-2 py-1 hover-scale transition-transform animate-fade-in" onMouseMove={e => {
                ...
                e.currentTarget.style.setProperty("--spotlight-y", `${y}px`);
                  ...
                  background: "radial-gradient(350px circle at var(--spotlight-x, 50%) var(--spotlight-y, 0%), hsl(var(--brand) / 0.15), transparent 40%)"
                }} />
                  Excel/Sheets
                </li>
                <li className="group relative rounded-md px-2 py-1 hover-scale transition-transform animate-fade-in" onMouseMove={e => {
        ...
        <section id="experience" className="container mx-auto px-4 md:px-8 mt-16 md:mt-24">
          ...
          points: ["Led end-to-end data reporting for 25,000+ students, improving forecasting accuracy to 98%.", "Streamlined reconciliation of 50,000+ accommodation records using Power BI and Excel.", "Automated GDPR-compliant document generation, reducing workload by 60%."]
        }, {
          role: "Business Analyst",
          company: "Robinson Moore, UK",
          period: "Oct 2023 – Mar 2024",
          points: ["Analysed CRM user engagement for 5,000+ users, boosting daily active users by 25%.", "Cleaned customer data across 8 systems for accurate CRM migration (+35% lead assignment accuracy).", "Created workflow visualizations, reducing turnaround time by 30%."]
        }, {
          role: "Founder",
          company: "Artwitch LLP, India",
          period: "Nov 2020 – Jan 2023",
          points: ["Built forecasting models for artist commissions, increasing fulfilment rate by 30%.", "Managed analytics for 20+ hospitality brands, growing B2B revenue 7.5x in 18 months.", "Developed budget dashboards maintaining 95% adherence to spending plans."]
        }]} />
        </section>
        ...
        <section id="contact" className="container mx-auto px-4 md:px-8 mt-16 md:mt-24 mb-20">
          <div className="group relative rounded-2xl border border-border/40 p-8 bg-card text-center overflow-hidden hover:shadow-glow transition" onMouseMove={e => {
          const rect = (e.currentTarget as HTMLElement).getBoundingClientRect();
          const x = e.clientX - rect.left;
          const y = e.clientY - rect.top;
          e.currentTarget.style.setProperty("--spotlight-x", `${x}px`);
